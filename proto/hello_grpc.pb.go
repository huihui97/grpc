...
// SayHelloClient is the client API for SayHello server.
//
...
// SayHelloServer is the server API for SayHello server.
...
// UnsafeSayHelloServer may be embedded to opt out of forward compatibility for this server.
...
// SayHello_ServiceDesc is the grpc.ServiceDesc for SayHello server.
